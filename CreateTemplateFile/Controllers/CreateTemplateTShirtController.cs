...
{
    public class CreateTemplateTShirtController : Controller
    {
        // GET: CreateTemplateTShirt
          ...
          HttpPostedFileBase product)
        {
            ...
            var BJ = model.BulletPoint1;
            var BK = model.BulletPoint2;
            var BL = model.BulletPoint3;
            var BM = model.BulletPoint4;
            var BN = model.BulletPoint5;
            var BO = model.GenericKeywords;
            var Z = model.ProductDescription;
            var HK = model.ShippingTemplate;
            ...
            {  
                ...
                for (int i = 2; i <= row; i++)
                {
                    ...
                    {
                        sheetTemplate.Cells["A" + (rowBegin + j)].Value = "shirt";
                        sheetTemplate.Cells["C" + (rowBegin + j)].Value = generic;
                        sheetTemplate.Cells["G" + (rowBegin + j)].Value = "fashion-t-shirts";
                        sheetTemplate.Cells["H" + (rowBegin + j)].Value = "Cotton";
                        sheetTemplate.Cells["M" + (rowBegin + j)].Value = "Cotton ";
                        sheetTemplate.Cells["M" + (rowBegin + j)].Value = "unisex-adult";
                        sheetTemplate.Cells["X" + (rowBegin + j)].Value = "Yes";
                        sheetTemplate.Cells["AB" + (rowBegin + j)].Value = "Unisex";
                        sheetTemplate.Cells["AC" + (rowBegin + j)].Value = "Adult";
                        sheetTemplate.Cells["BA" + (rowBegin + j)].Value = "color-size";
                        sheetTemplate.Cells["BJ" + (rowBegin + j)].Value = BJ;
                        sheetTemplate.Cells["BK" + (rowBegin + j)].Value = BK;
                        sheetTemplate.Cells["BM" + (rowBegin + j)].Value = BL;
                        sheetTemplate.Cells["BN" + (rowBegin + j)].Value = BM;
                        sheetTemplate.Cells["BJ" + (rowBegin + j)].Value = BN;
                        sheetTemplate.Cells["BO" + (rowBegin + j)].Value = BO;
                        sheetTemplate.Cells["Z" + (rowBegin + j)].Value = Z;
                        sheetTemplate.Cells["HK" + (rowBegin + j)].Value = HK;
                    ...
                    for (int j = 2; j <= rowCategory; j++)
                    {
                        ...
                        sheetTemplate.Cells["Y" + (rowBegin + 1)].Value = pirce;
                        // lay dc size AU
